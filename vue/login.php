...
<body>
    <div class="main" >
        ...
        ?>
        <form class="form1" action="../controle/Commander.php" method="post">
...
<?php }else{
    ...
    $_SESSION['nbrPlat'] = $_POST['nbrPlat'];
    $_SESSION['sizePlat'] = $_POST['sizePlat'];
    header("Location:../controle/Commander.php");
    exit();
} ?>
