...
<body>
    <div class="main" >
        ...
        ?>
        <form class="form1" action="../controle/CommanderAnnif.php" method="post">
        ...
        <form action="registerAnnif.php" method="post">
            <input type="hidden" id="nom" name="typeTarte" value="<?php print base64_encode(serialize($_POST['typeTarte'])); ?>" />
            <input type="hidden" id="type" name="sizeTarte" value="<?php print base64_encode(serialize($_POST['sizeTarte'])); ?>" />
            <input type="hidden" id="nbrPlat" name="nbrTarte" value="<?php print base64_encode(serialize($_POST['nbrTarte'])); ?>" />
            <input type="hidden" name="date" value="<?=$_POST['date']?>" />
...
<?php }else{
    $_SESSION['typeTarte'] = $_POST['typeTarte'];
    $_SESSION['sizeTarte'] = $_POST['sizeTarte'];
    $_SESSION['nbrTarte'] = $_POST['nbrTarte'];
    $_SESSION['date'] = $_POST['date'];
    $_SESSION['time'] = $_POST['time'];
    $_SESSION['nbrPlace'] = $_POST['nbrPlace'];
    $_SESSION['typeTable'] = $_POST['typeTable'];
    header("Location:../controle/CommanderAnnif.php");
    exit();
} ?>
