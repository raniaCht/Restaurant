...
function checknum(){
  ...
  document.getElementById('message_tel').innerHTML = "le numéro de telephone valide";
  }else{
    document.getElementById('message_tel').style.color = 'red';
  document.getElementById('message_tel').innerHTML = "le numéro de telephone n'est pas valide";
  }
} 
...
<div class="login">
    ...
    <form method="post" action="../controle/Commander.php">
        ...
        <input type="hidden" id="nom" name="nomP" value="<?php print base64_encode(serialize($_POST['nomP'])); ?>" />
      		<input type="hidden" id="type" name="type" value="<?php print base64_encode(serialize($_POST['type'])); ?>" />
      		<input type="hidden" id="nbrPlat" name="nbrPlat" value="<?php print base64_encode(serialize($_POST['nbrPlat'])); ?>" />
            <input type="hidden" id="sizePlat" name="sizePlat" value="<?php print base64_encode(serialize($_POST['sizePlat'])); ?>" />
